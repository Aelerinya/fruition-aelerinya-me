 ...
 */
const SLUG_TO_PAGE = {
	'': 'c1deefa7fbc64ed5b3bb7dd98b963f8d',
};
...
async function fetchAndApply(request: Request) {
	...
	if (url.pathname === '/.well-known/discord') {
		return new Response('dh=2376294f5978653c5116ec82c301dd6532cc035a');
	}
...
class BodyRewriter {
	constructor(private SLUG_TO_PAGE: Record<string, string>) {}
	element(element: Element) {
		element.append(
